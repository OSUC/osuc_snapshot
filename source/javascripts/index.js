...
function loader() {
	...
	xbiod.init(['taxon', 'visual', 'search'], 'FBF57A9F7A666FC0E0430100007F0CDC', function() {

		// Setting path variables
		xbiod.base.paths.taxon_path = '/';
		...
		if (TEST){
			...
			search.showSearch('search_id', {search_type: 'id', inst_id: inst_id, domains: [{type: 'taxon', handler_url: xbiod.base.paths.taxon_path}]});
			...
			taxon.showSubordinateTaxa('half_width_c2', tnuid, {inst_id: inst_id, widget_options: {initial_height: '700px'}});

			// Load map
			visual.showGoogleMap('full_width_c1', tnuid, {inst_id: 1, show_children:'N', markers: 'spiderfy', widget_options: {initial_height: '500px'}});
